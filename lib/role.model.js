 ...
 * @module Role
 * @name Role
 * @description A representation on how a party(ies) acts or, in other words,
...
const { getNumber, getString, getStrings } = require('@lykmapipo/env');
...
RoleSchema.statics.seed = function seed(seeds, done) {
  ...
  ROLE_SEED =
    _.uniq(_.compact([].concat(ADMINISTRATOR_ROLE_NAME).concat(ROLE_SEED)));
